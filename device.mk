...
PRODUCT_COPY_FILES += \
    device/lge/bullhead/init.bullhead.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/hw/init.bullhead.rc \
    device/lge/bullhead/init.bullhead.usb.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/hw/init.bullhead.usb.rc \
    ...
    device/lge/bullhead/ueventd.bullhead.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/hw/ueventd.bullhead.rc \
    device/lge/bullhead/init.recovery.bullhead.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/hw/init.recovery.bullhead.rc \
    device/lge/bullhead/init.bullhead.ramdump.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/hw/init.bullhead.ramdump.rc \
    device/lge/bullhead/init.bullhead.fp.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/hw/init.bullhead.fp.rc \
...
PRODUCT_COPY_FILES += \
    ...
    device/lge/bullhead/media_codecs.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs.xml \
    device/lge/bullhead/media_codecs_performance.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_performance.xml \
    device/lge/bullhead/media_profiles.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_profiles.xml

# Audio
PRODUCT_COPY_FILES += \
    device/lge/bullhead/audio_output_policy.conf:$(TARGET_COPY_OUT_VENDOR)/etc/audio_output_policy.conf \
...
#Sound Trigger
PRODUCT_COPY_FILES += \
    device/lge/bullhead/sound_trigger_mixer_paths.xml:$(TARGET_COPY_OUT_VENDOR)/etc/sound_trigger_mixer_paths.xml \
    device/lge/bullhead/sound_trigger_platform_info.xml:$(TARGET_COPY_OUT_VENDOR)/etc/sound_trigger_platform_info.xml
